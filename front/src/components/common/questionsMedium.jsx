...
import StructureQuestionMedium from "./structureQuestionMedium";
import { Link } from "react-router-dom";

function QuestionsMedium() {
          ...
          <>
            <div className="d-flex justify-content-center">
              <div style={{ margin: "10px" }}>
                <Link
                  to={`/questions/editMediumQuestion/${
