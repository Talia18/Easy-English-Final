...
function StructureQuestionEasy({ question }) {
  ...
  optionsArray.push(correctOption[0]);
  const falseOption = question.options.filter(
    (option) => option.correct === false
  );
  optionsArray.push(falseOption[0]);
...
export default StructureQuestionEasy;
