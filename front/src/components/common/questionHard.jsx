...
import StructureQuestionHard from "./structureQuestionHard";
import { Link } from "react-router-dom";

function QuestionsHard() {
    ...
    <>
      ...
      <div className="d-flex flex-column fs-3 p-3 m-3 align-items-center">
        {allQuestions.length > 0 && (
          <StructureQuestionHard
            key={allQuestions[currentQuestion - 1]._id}
